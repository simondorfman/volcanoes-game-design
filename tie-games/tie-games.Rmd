...
total_moves_to_player_who_played_turn_before_last <- function(total_moves) {
  ...
  if (total_moves_minus_one_divided_by_six_remainder %in% c(1,5)) {
    return("One")
  } else if (total_moves_minus_one_divided_by_six_remainder %in% c(2,4)) {
    return("Two")
  } else if (total_moves_minus_one_divided_by_six_remainder %in% c(0,3)) {
    return("Growth")
  } else {
    return("Empty")
  }
